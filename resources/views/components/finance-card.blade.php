...
<div class="relative flex flex-col min-w-0 mb-6 break-words text-white bg-slate-800 hover:bg-slate-700 cursor-pointer shadow-soft-xl rounded-2xl bg-clip-border">
